...
class OverviewDataSource: NSObject, AppSectionDataSource {
    ...
    init(app: App) {
        ...
        self.data = [
            ...
            OverviewItem(title: "Number of reviews", subtitle: "\(app.reviewsCount.value)"),
            OverviewItem(title: "Number of what's new", subtitle: "\(app.whatsNewCount.value)"),
            OverviewItem(title: "Country", subtitle: app.details.country),
            OverviewItem(title: "Genre", subtitle: app.details.genre),
            OverviewItem(title: "In-app purchases", subtitle: app.details.hasIap.value ? "Yes" : "No"),
